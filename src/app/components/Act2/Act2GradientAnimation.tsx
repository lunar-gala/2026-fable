...
// Define mobile height maps for rows
const mobileSizeHeightMap = {
    xs2xl:"3%",
    xs2l:"3%",
    s2m:"6.25%",
    m2s:"12.5%",
                ...
                <motion.div 
                    ...
                    style={{
                        height: useTransform(
                            ...
                            [0.52, 0.60],
                            isMobile
                                ? [mobileSizeHeightMap[row.size], mobileNextSizeHeightMap[row.size]]
                                : [sizeHeightMap[row.size], nextSizeHeightMap[row.size]]
                        )
                    }}   
                    key={rowIdx}
                >
