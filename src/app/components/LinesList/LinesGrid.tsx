  ...
  return (
    ...
    <div className='grid100vh whitebg'>
        <div className='xs-row rowGrid'>
            ...
            <div className='landingCell m-cell c8'></div>   
            <div className='landingCell xs-cell c7'></div>  
        ...
        <div className='m-row rowGrid'>
            ...
            <div className='landingCell m-cell c8'></div>   
            <div className=' landingCell xs-cell c7'></div>  
             <div className='a1linegradientV landingCell m-cell c6'></div>   
            <div className='landingCell xs-cell c6'></div>  
             <div className='landingCell m-cell c5'></div>   
            <div className='landingCell xs-cell c4'></div>  
             <div className='landingCell m-cell c3'></div>   
        ...
        <div className='m-row rowGrid'>
            ...
            <div className='landingCell m-cell c8'></div>   
            <div className='landingCell xs-cell c7'></div>  
             <div className='a2linegradientV landingCell m-cell c6'></div>   
            <div className='landingCell xs-cell c6'></div>  
             <div className='landingCell m-cell c5'></div>   
            <div className='landingCell xs-cell c4'></div>  
             <div className='landingCell m-cell c3'></div>   
        ...
        <div className='m-row rowGrid'>
            ...
            <div className=' landingCell m-cell c7'></div>   
            <div className='landingCell xs-cell c8'></div>  
            <div className='a3linegradientH landingCell m-cell c8'></div>   
            <div className='landingCell xs-cell c7'></div>  
             <div className=' landingCell m-cell c6'></div>   
            <div className='landingCell xs-cell c6'></div>  
             <div className='landingCell m-cell c5'></div>   
        ...
        <div className='m-row rowGrid'>
            ...
            <div className='landingCell m-cell c8'></div>   
            <div className='landingCell xs-cell c7'></div>  
             <div className='a4linegradientV landingCell m-cell c6'></div>   
            <div className='landingCell xs-cell c6'></div>  
             <div className='landingCell m-cell c5'></div>   
            <div className='landingCell xs-cell c4'></div>  
