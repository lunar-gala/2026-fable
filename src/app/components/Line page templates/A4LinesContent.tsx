...
export default function A4LinesContent({ lineName, lineTagline, lineDescription, lineDesigners }: A4LinesContentProps) {
  return (
    <div className="grid100vh linesPageGrid">
      ...
      <div className="l-row rowGridContent">
        ...
        <div className="homeCell-content xs-cell c6" />
        <div className="  homeCell-content col2cell c6">
            <div className=" spacer50w a1LineHeading">
              <h1>{lineName}</h1>
      ...
      <div className="l-row rowGridContent">
        ...
        <div className="flexstretch homeCell-content col2cell c4">
